  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8" style={{ position: 'relative', zIndex: 1 }}>
      ...
      <div className="mb-6">
        ...
        {article.description && (
          <p className="text-text-secondary leading-relaxed text-sm border-l-2 border-accent-purple/40 pl-4">
            {article.description}
          </p>
        )}
      </div>
            ...
            {openSection === 'summary' && (
              <div className="px-4 pb-4 border-t border-white/5">
                {summaryLoading ? (
                  ...
                  <p className="text-text-secondary text-sm leading-relaxed pt-3">{summary}</p>
                ) : (
            ...
            {showTranslate && (
              <div className="px-4 pb-4 border-t border-white/5">
                {translating ? (
                  ...
                  <p className="text-text-secondary text-sm leading-relaxed pt-3 whitespace-pre-line">{translated}</p>
                )}
              </div>
            )}
          </div>
